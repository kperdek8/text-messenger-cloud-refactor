defmodule TextMessengerBackend.ChatServiceWeb.Auth.Cognito do
  import Plug.Conn
  use Joken.Config
  ...
  defp issuer, do: Application.get_env(:chat_service, :cognito)[:issuer]
  defp client_id, do: Application.get_env(:chat_service, :aws)[:client_id]
  defp jwks_url, do: Application.get_env(:chat_service, :cognito)[:jwks_url]
