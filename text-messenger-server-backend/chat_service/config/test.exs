...
config :chat_service, TextMessengerBackend.ChatServiceWeb.Endpoint,
  ...
  secret_key_base: "WSrfPWdIMOSVm4I2ZDEZqOA6w49ZNr8B1r8JC6TERUGM1LT1K91/V3Ll3c8Tqsk/",
  server: false

# In test we don't send emails
config :chat_service, TextMessengerBackend.ChatService.Mailer, adapter: Swoosh.Adapters.Test
